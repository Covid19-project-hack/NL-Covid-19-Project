...
import com.nlcovid19project.Adapter.CoronaAdapter;
import com.nlcovid19project.Adapter.FAQAdapter;
import com.nlcovid19project.Models.Corona;
import com.nlcovid19project.Models.FAQ;
        ...
        JsonObjectRequest request1 = new JsonObjectRequest(Request.Method.GET,url1, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONObject jsonObject = response.getJSONObject("Nagaland").getJSONObject("districtData");
